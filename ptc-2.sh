...
#SBATCH --output=/sdf/home/a/abrought/run6/output/out2.txt
#SBATCH --error=/sdf/home/a/abrought/run6/output/err2.txt
#SBATCH --ntasks=5
...
pipetask run  \
    ...
    -o u/abrought/ptc.13511.test.2 \
    -p $CP_PIPE_DIR/pipelines/_ingredients/cpPtc-complete-solver-LongRangeCovsOff.yaml \
