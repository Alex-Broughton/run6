...
#SBATCH --output=/sdf/home/a/abrought/run6/output/out1.txt
#SBATCH --error=/sdf/home/a/abrought/run6/output/err1.txt
#SBATCH --ntasks=5
...
pipetask run  \
    ...
    -o u/abrought/ptc.13511.test.7 \
    -p $CP_PIPE_DIR/pipelines/_ingredients/cpPtc-complete-solver-defaults.yaml \
